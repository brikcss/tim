 ...
 *
 *  @param  {object}  [options|string]  Options passed to cosmiconfig. Must have either startPath or entry (entry takes precedence). If a string is passed, it will be used as options.startPath. See the `_brik` property in `.brikrc-defaults.js` for more details.

...
const utils = {
	mergeable: 'is-mergeable-object',
	merge: './merge',
	isObject: './is-object',
	isArray: function(value) {
		return tim.utils.isObject(value, { type: Array });
	},
	isMergeable: function(value) {
		return tim.utils.isObject(value, { mergeable: true });
	},
	timer: {
		_: {},
		start: id => {
	...
	wrapText,
	getRoot,
	pathAbsolute(path, cwd = process.cwd()) {
		return tim.path.isAbsolute(path) ? path : tim.path.resolve(cwd, path);
	},
	sortObject
};
